  ...
  return (
    <div className="space-y-6">
      <PageHeaderCard
        ...
        extra={<QrCode className="h-6 w-6" />}
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatBrazilianCurrency(stats?.payment_pix || 0)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{pixStats.total}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatBrazilianCurrency(pixStats.todayValue)}</div>
            <p className="text-xs text-muted-foreground">{pixStats.todayCount} transações hoje</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{pixStats.uniqueUsers}</div>
            <p className="text-xs text-muted-foreground">Usuários que usaram PIX</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Transações PIX ({filteredTransactions.length})</CardTitle>
