...
const AdminPagamentosCartao = () => {
  ...
  // Calcular estatísticas de cartão
  ...
  return (
    <div className="space-y-6">
      <PageHeaderCard
        title="Pagamentos Cartão de Crédito"
        subtitle="Análise detalhada de todas as transações de cartão de crédito"
        extra={<CreditCard className="h-6 w-6" />}
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatBrazilianCurrency(stats?.payment_card || 0)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatBrazilianCurrency(cardStats.todayValue)}</div>
            <p className="text-xs text-muted-foreground">{cardStats.todayCount} transações hoje</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{cardStats.uniqueUsers}</div>
            <p className="text-xs text-muted-foreground">Usuários que usaram cartão</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Transações Cartão ({filteredTransactions.length})</CardTitle>
